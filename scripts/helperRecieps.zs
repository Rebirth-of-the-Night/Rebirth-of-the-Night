...
archRecipe(<contenttweaker:arch_brick_rhyolite>, <contenttweaker:arch_large_brick_rhyolite>, <undergroundbiomes:igneous_brick:2>);
archRecipe(<contenttweaker:arch_brick_andesite>, <contenttweaker:arch_large_brick_andesite>, <undergroundbiomes:igneous_brick:3>);
archRecipe(<contenttweaker:arch_brick_gabbro>, <contenttweaker:arch_large_brick_gabbro>, <undergroundbiomes:igneous_brick:4>);
archRecipe(<contenttweaker:arch_brick_basalt>, <contenttweaker:arch_large_brick_basalt>, <undergroundbiomes:igneous_brick:5>);
archRecipe(<contenttweaker:arch_brick_komatiite>, <contenttweaker:arch_large_brick_komatiite>, <undergroundbiomes:igneous_brick:6>);
archRecipe(<contenttweaker:arch_brick_dacite>, <contenttweaker:arch_large_brick_dacite>, <undergroundbiomes:igneous_brick:7>);
...
archRecipe(<contenttweaker:arch_brick_marble>, <contenttweaker:arch_large_brick_marble>, <undergroundbiomes:metamorphic_brick:2>);
archRecipe(<contenttweaker:arch_brick_quartzite>, <contenttweaker:arch_large_brick_quartzite>, <undergroundbiomes:metamorphic_brick:3>);
archRecipe(<contenttweaker:arch_brick_blue_schist>, <contenttweaker:arch_large_brick_blue_schist>, <undergroundbiomes:metamorphic_brick:4>);
archRecipe(<contenttweaker:arch_brick_green_schist>, <contenttweaker:arch_large_brick_green_schist>, <undergroundbiomes:metamorphic_brick:5>);
archRecipe(<contenttweaker:arch_brick_soapstone>, <contenttweaker:arch_large_brick_soapstone>, <undergroundbiomes:metamorphic_brick:6>);
archRecipe(<contenttweaker:arch_brick_migmatite>, <contenttweaker:arch_large_brick_migmatite>, <undergroundbiomes:metamorphic_brick:7>);
