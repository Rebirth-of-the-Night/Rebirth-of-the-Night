...
JEI.addDescription(<contenttweaker:ferrought_flesh_deposit>,"Fresh ferrought deposits still form in the flesh of the Nether to this day, usually causing streams of blood.");
...
JEI.addDescription(<da:volatile_orb>,"Sticky organ of some creatures with potential for alchemy. Although superficially similar to slime, this gooey substance is fundamentally different.");
...
JEI.addDescription(<randomthings:ingredient:2>,"Plasmion is the matter conjured on the physical plane by the manifestation of strong-willed spirits, curses, amalgams, revenants, and the like. This ethereal matter is a more solid variant of spiritfire, and similar to lifeblood.");
JEI.addDescription(<da:crystal_trinket>,"Long ago, a hero of a distant land banquished a great evil. He trained under the Continued, learning to channel his rage, his fight, making it his own. His deeds saved many and inspired some to follow his steps, but his victory was not without cost... some from his order succumbed to the strife, and where moreover cursed to roam by the echoes of the great evil.");
...
val dummy_stoked_fire = <contenttweaker:stoked_fire_block>;
...
JEI.addDescription(dummy_fire,"Fire! One of the staples of intelligent species, alongside carving light stones to conquer the dark. Ignite a fire using a hand drill, a flint and steel, a fire charge... or more obscure methods. More often than not, fire is best used in controlled environments, like torches, plain hibachis, campfires and furnaces.");
JEI.addDescription(dummy_stoked_fire, "Superheated by the constant stoking of a everfire-powered Hibachi with bellows. It can heat a cooking cauldron or crucible to the level necessary for new creations. Take care when using it; some recipes may not play with the superheated temperatures too nicely...");
...
JEI.addDescription(<behgameon:accessory_32>, "This amulet depicts Thymos-Eros, the symbol of Asaiosa. It is imbued with life essence that can ward off attacks to the heart and increase vitality. Holding a Staff of Harmony on either hand along with this charm, like the priests that learned to control their passion, will grant complete protection of the heart.");
JEI.addDescription(<behgameon:accessory_17>, "A bearing with more qualities than meets the eye. This technology was of common use by the ancient civilization of the depths, but is found now in ruins or carried by goblins, though not the only ones to apply this item practically. In their hands, brass was like the elements are to the greater spirits. Knowing the bearing design makes it easier for a master crafter to reproduce.");
