...
val vessel_salt = <rotntweaker:smelting_vessel>.withTag({recipe_flag: "salty_water"});

val clay_ball = <minecraft:clay_ball>;
val dust_copper = <ore:dustCopper>;
val dust_tin = <ore:dustTin>;

JEI.addItem(vessel_salt);
JEI.addItem(vessel_source_bronze);
JEI.addItem(vessel_ingot_bronze);
