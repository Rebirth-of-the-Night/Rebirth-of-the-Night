...
CrudeDryingRack.addRecipe("mud_dirt", <contenttweaker:weathered_dirt>, <biomesoplenty:mud>, 8 * 60 * 20, true);
CrudeDryingRack.addRecipe("mudball_dirt", <betterwithmods:dirt_pile>, <biomesoplenty:mudball>, 8 * 60 * 20, true);
