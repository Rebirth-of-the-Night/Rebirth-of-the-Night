...
Dropt.list("pile_rocky_dirt")
  ...
  .add(Dropt.rule()
	  ...
	  .addDrop(Dropt.drop()
          .selector(Dropt.weight(1))
       	   .items([<pyrotech_compat:rock_sedimentary:1>], Dropt.range(2))
      )
  );
...
Dropt.list("rock_coade")
  ...
  .add(Dropt.rule()
      .matchBlocks(["minecraft:stone", "minecraft:cobblestone", "minecraft:mossy_cobblestone"])
	  .matchHarvester(Dropt.harvester()
          .type("PLAYER")
...
Dropt.list("rock_red_granite")
  ...
  .add(Dropt.rule()
      .matchBlocks(["undergroundbiomes:igneous_cobble", "undergroundbiomes:igneous_stone", "undergroundbiomes:igneous_overgrown"])
	  .matchHarvester(Dropt.harvester()
          .type("PLAYER")
		  .mainHand("BLACKLIST", [], "pickaxe;1;-1")
	  )
