...
//Bleakseal
var arch_brick_bleakseal = VanillaFactory.createDirectionalBlock("arch_brick_bleakseal", <blockmaterial:Rock>, "HORIZONTAL", true, true);
arch_brick_bleakseal.setBlockHardness(2.0);
arch_brick_bleakseal.setBlockResistance(1.0);
arch_brick_bleakseal.axisAlignedBB = AxisAlignedBB.create(
     0.0 / 16.0,
     0.0 / 16.0,
     16.0 / 16.0,
	16.0 / 16.0,
...
arch_brick_bleakseal.setToolClass("pickaxe");
arch_brick_bleakseal.setFullBlock(false);
arch_brick_bleakseal.setLightOpacity(0);
arch_brick_bleakseal.setLightValue(0);
arch_brick_bleakseal.setBlockLayer("CUTOUT");
arch_brick_bleakseal.register();

var arch_large_brick_bleakseal = VanillaFactory.createDirectionalBlock("arch_large_brick_bleakseal", <blockmaterial:Rock>, "HORIZONTAL", true, true);
arch_large_brick_bleakseal.setBlockHardness(2.0);
arch_large_brick_bleakseal.setBlockResistance(1.0);
arch_large_brick_bleakseal.axisAlignedBB = AxisAlignedBB.create(
     0.0 / 16.0,
     0.0 / 16.0,
     16.0 / 16.0,
	16.0 / 16.0,
...
arch_large_brick_bleakseal.setToolClass("pickaxe");
arch_large_brick_bleakseal.setFullBlock(false);
arch_large_brick_bleakseal.setLightOpacity(0);
arch_large_brick_bleakseal.setLightValue(0);
arch_large_brick_bleakseal.setBlockLayer("CUTOUT");
arch_large_brick_bleakseal.register();
...
//Raktan
var arch_brick_raktan = VanillaFactory.createDirectionalBlock("arch_brick_raktan", <blockmaterial:Rock>, "HORIZONTAL", true, true);
arch_brick_raktan.setBlockHardness(2.0);
arch_brick_raktan.setBlockResistance(1.0);
arch_brick_raktan.axisAlignedBB = AxisAlignedBB.create(
     0.0 / 16.0,
     0.0 / 16.0,
     16.0 / 16.0,
	16.0 / 16.0,
...
arch_brick_raktan.setToolClass("pickaxe");
arch_brick_raktan.setFullBlock(false);
arch_brick_raktan.setLightOpacity(0);
arch_brick_raktan.setLightValue(0);
arch_brick_raktan.setBlockLayer("CUTOUT");
arch_brick_raktan.register();

var arch_large_brick_raktan = VanillaFactory.createDirectionalBlock("arch_large_brick_raktan", <blockmaterial:Rock>, "HORIZONTAL", true, true);
arch_large_brick_raktan.setBlockHardness(2.0);
arch_large_brick_raktan.setBlockResistance(1.0);
arch_large_brick_raktan.axisAlignedBB = AxisAlignedBB.create(
     0.0 / 16.0,
     0.0 / 16.0,
     16.0 / 16.0,
	16.0 / 16.0,
...
arch_large_brick_raktan.setToolClass("pickaxe");
arch_large_brick_raktan.setFullBlock(false);
arch_large_brick_raktan.setLightOpacity(0);
arch_large_brick_raktan.setLightValue(0);
arch_large_brick_raktan.setBlockLayer("CUTOUT");
arch_large_brick_raktan.register();