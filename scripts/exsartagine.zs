...
recipes.addShaped("exsar_wok", <exsartagine:wok>, [
...
JEI.removeAndHide(<exsartagine:veggie_bread_raw>);
JEI.removeAndHide(<exsartagine:veggie_bread>);
JEI.removeAndHide(<exsartagine:bread_meat_raw>);
JEI.removeAndHide(<exsartagine:bread_meat>);
...
ExSartagine.addPlaceable(<blockstate:betterwithmods:stoked_flame>.getBlock(),true,true);
ExSartagine.addPlaceable(<blockstate:futuremc:blast_furnace>.getBlock(),false);
ExSartagine.addPlaceable(<blockstate:futuremc:blast_furnace:facing=east,lit=true>,true);
ExSartagine.addPlaceable(<blockstate:futuremc:blast_furnace:facing=west,lit=true>,true);
ExSartagine.addPlaceable(<blockstate:futuremc:blast_furnace:facing=north,lit=true>,true);
ExSartagine.addPlaceable(<blockstate:futuremc:blast_furnace:facing=south,lit=true>,true);
ExSartagine.addPlaceable(<blockstate:futuremc:smoker>.getBlock(),false);
ExSartagine.addPlaceable(<blockstate:futuremc:smoker:facing=north,lit=true>,true);
ExSartagine.addPlaceable(<blockstate:futuremc:smoker:facing=south,lit=true>,true);
ExSartagine.addPlaceable(<blockstate:futuremc:smoker:facing=west,lit=true>,true);
ExSartagine.addPlaceable(<blockstate:futuremc:smoker:facing=east,lit=true>,true);
ExSartagine.addPlaceable(<blockstate:pyrotech:campfire>.getBlock(),false,true);
ExSartagine.addPlaceable(<blockstate:pyrotech:campfire:ash=0,variant=lit>,true,true);
ExSartagine.addPlaceable(<blockstate:pyrotech:campfire:ash=1,variant=lit>,true,true);
ExSartagine.addPlaceable(<blockstate:pyrotech:campfire:ash=2,variant=lit>,true,true);
ExSartagine.addPlaceable(<blockstate:pyrotech:campfire:ash=3,variant=lit>,true,true);
ExSartagine.addPlaceable(<blockstate:pyrotech:campfire:ash=4,variant=lit>,true,true);
ExSartagine.addPlaceable(<blockstate:pyrotech:campfire:ash=5,variant=lit>,true,true);
ExSartagine.addPlaceable(<blockstate:pyrotech:campfire:ash=6,variant=lit>,true,true);
...
ExSartagine.removeKettleRecipe([<exsartagine:spaghetti_cooked>] as IItemStack[]);

//Removed furnace food recipes to remove it from Ex Sarta stations
furnace.remove(<dungeontactics:toast>);

/* ExSarta utility Ore Entries */
...
//Knife: can be stuck on a cutting board
val knife = <ore:knife>;
knife.add(<animania:carving_knife:*>);

//Spatula: can flip spatula recipes in the wok. By default wooden shovel
val spatula = <ore:spatula>;

//self igniter: makes hearth ignite on its own. By default blaze powder
val self_igniter = <ore:exsartagine:self_igniter_upgrade>;
self_igniter.add(<contenttweaker:wrought_animation_core>);
...
-"Grilled" items are cooked in the wok, if they are more complex, then they are cooked in the kettle.
...
var smallKnife = <ore:smallKnife>;
var cuttingImplement = <ore:cuttingImplement>;
...
ExSartagine.addWokRecipe([aSparagus],[<harvestcraft:grilledasparagusitem>]);
//Baked Sweet Potato
...
ExSartagine.addWokRecipe([eggplant],[<harvestcraft:grilledeggplantitem>]);
//Buttered Toast
...
//stocke ExSartagine.addKettleRecipe([rawBeef,potato,carrot,stock],cookKitKettle,null,[<harvestcraft:potroastitem>],80);
//Fish sandwich
...
ExSartagine.addWokRecipe([egg], [<harvestcraft:friedeggitem>]);
//Scrambled egg
...
ExSartagine.addWokRecipe([sugar], [<harvestcraft:caramelitem>]);
...
//stocke ExSartagine.addKettleRecipe([onion,butter,stock],cookKitKettle,null,[<harvestcraft:braisedonionsitem>],80);
//Corn on the cob
RecipeBuilder.get("chef")
...
//stocke ExSartagine.addKettleRecipe([anyRawMeat,flour,stock],cookKitKettle,null,[<harvestcraft:meatystewitem>],80);
//Mixed Salad -&R
...
//Carbonated Sparkling Drinks [KEEPER] (purpose of the soda makers, Shadits best invention*)
...
ExSartagine.addWokRecipe([chestnut],[<harvestcraft:roastedchestnutitem>]);
...
ExSartagine.addKettleRecipe([<biomesoplenty:flower_1>,dough],cookKitKettle,null,[<harvestcraft:lavendershortbreaditem>],80);
//Beef-wellington [KEEPER]
...
//stocke ExSartagine.addKettleRecipe([rawChicken,bellpepper,stock,spice,veggie,veggie,veggie],cookKitKettle,null,[<harvestcraft:chickengumboitem>],80);
...
//stocke recipes.addShapeless("gravy", <harvestcraft:gravyitem>,[stock,flour]);
RecipeBuilder.get("chef")
  .setName("gravy")
...
//stocke ExSartagine.addKettleRecipe([rawChicken,<harvestcraft:noodlesitem>,onion,stewCondiment,stewCondiment,stock],cookKitKettle,null,[<harvestcraft:chickenchowmeinitem>],80);
//Kung Pao Chicken -&R
...
//stocke ExSartagine.addKettleRecipe([toast,spice,celery,veggie,stock],null,null,[<harvestcraft:stuffingitem>],80);
...
//stocke ExSartagine.addKettleRecipe([rawChicken,rawShrimp,rice,stock,onion,spice],null,null,[<harvestcraft:chickenpaellaitem>],80);
//Escargot -&R
...
//Slime Gummies [KEEPER]
recipes.remove(<harvestcraft:slimegummiesitem>);
ExSartagine.addKettleRecipe([<ore:slimeball>,<minecraft:sugar>],null,rennetBottle,[<harvestcraft:slimegummiesitem>*2],80);
//Chocolate Pudding
...
ExSartagine.addCuttingBoardRecipe(<animania:raw_prime_bacon>, cuttingImplement, <mod_lavacow:mousse>, 1);

//Beef
ExSartagine.addCuttingBoardRecipe(<animania:raw_prime_beef>, cuttingImplement, <animania:raw_prime_steak>*4, 4);
ExSartagine.addCuttingBoardRecipe(<animania:raw_prime_steak>, cuttingImplement, <contenttweaker:ground_beef>, 1);

//Cheese
ExSartagine.addCuttingBoardRecipe(<animania:friesian_cheese_wheel>, cuttingImplement, <animania:friesian_cheese_wedge>*8, 16);

ExSartagine.addCuttingBoardRecipe(<animania:holstein_cheese_wheel>, cuttingImplement, <animania:holstein_cheese_wedge>*8, 16);

ExSartagine.addCuttingBoardRecipe(<animania:jersey_cheese_wheel>, cuttingImplement, <animania:jersey_cheese_wedge>*8, 16);

ExSartagine.addCuttingBoardRecipe(<animania:goat_cheese_wheel>, cuttingImplement, <animania:goat_cheese_wedge>*8, 16);

ExSartagine.addCuttingBoardRecipe(<animania:sheep_cheese_wheel>, cuttingImplement, <animania:sheep_cheese_wedge>*8, 16);
//unimplemented wheels
...
//ExSartagine.addSmelterRecipe(<minecraft:sapling:3>, <minecraft:nether_wart>, 20);
...
*/
//Rennet
ExSartagine.addKettleRecipe([<rustic:wind_thistle>],null,waterBottle,rennetBottle,[null],600);//liquid
...
ExSartagine.addKettleRecipe([<growthcraft_milk:thistle>],null,waterBottle,rennetBottle,[null],600);//liquid
...
ExSartagine.addKettleRecipe([<growthcraft_milk:stomach>],null,waterBottle,rennetBottle,[null],600);//liquid
...
ExSartagine.addKettleRecipe([fig],null,waterBottle,rennetBottle,[null],600);//liquid
...
ExSartagine.addKettleRecipe([<ore:agedMold>],null,waterBottle,rennetBottle,[null],600);//liquid
