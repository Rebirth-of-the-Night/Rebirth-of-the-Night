...
# Viridium
mods.jei.JEI.addDescription(<ore:ingotViridium>,"Viridium is found deep underground in the Beneath. A brittle, almost glasslike material; strangely light... literally. Weighs very little, and gives off a dim glow in the otherwise suffocating darkness of the Beneath.");
...
# Mythril
mods.jei.JEI.addDescription(<ore:ingotMythril>,"Mythril is found deep underground in the Beneath, not always as an ore. A powerful arcane metal with peculiar traits that set it apart from other ores.");
...
mods.jei.JEI.addDescription(<simpleores:mythril_pickaxe>,"The cooler blue pickaxe. Mine with more grace than ever before!");
...
# Onyx
mods.jei.JEI.addDescription(<simpleores:onyx_ore>,"A reclusive crystalline mineral found in the Nether. Extremely tough and one of the hardest known materials. Tools made of Soulforged Steel or other... 'exotic' components are strong enough to break it into chunks.");
mods.jei.JEI.addDescription(<ore:gemOnyx>,"A reclusive crystalline mineral found in the Nether. Extremely tough and one of the hardest known materials. Tools made of Soulforged Steel or other... 'exotic' components are strong enough to break it into chunks like these.");
mods.jei.JEI.addDescription(<simpleores:onyx_block>,"Arguably one of the hardest materials to have ever existed. Somehow, in the hands of an expert crafter, it becomes illogically malleable, but few have successfully harvested Onyx and lived to tell about it...");
...
mods.jei.JEI.addDescription(<simpleores:onyx_sword>,"The sheer magnitude of this thing is enough to give any monster a hard time, especially in tandem with the onyx greatbow.");
